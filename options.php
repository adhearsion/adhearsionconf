...
/** CUSTOM **/
	...
	$options[] = array(
		'name' => __('Twitter Header', 'options_framework_theme'),
		'desc' => __('Ex: Your Company on Twitter', 'options_framework_theme'),
		'id' => 'twitter_header',
		'std' => '',
		'class' => 'mini',
		'type' => 'text');
	...
	$options[] = array(
		...
		'desc' => __('Ex: sideways8com', 'options_framework_theme'),
		'id' => 'twitter_user',
		'std' => '',
		'class' => 'mini',
		'type' => 'text');
	...
	$options[] = array(
		'name' => __('Github Link', 'options_framework_theme'),
		'id' => 'github_link',
		'std' => '',
		'class' => 'mini',
		'type' => 'text');
	$options[] = array(
		...
		'type' => 'text');
	$options[] = array(
		'name' => __('Mailing List Link', 'options_framework_theme'),
		'id' => 'mailing_list_link',
		'std' => '',
		'class' => 'mini',
		'type' => 'text');
	$options[] = array(
		'name' => __('Vimeo Link', 'options_framework_theme'),
		'id' => 'vimeo_link',
		'std' => '',
		'class' => 'mini',
		'type' => 'text');
	$options[] = array(
		'name' => __('Slideshare Link', 'options_framework_theme'),
		'id' => 'slideshare_link',
		'std' => '',
		'class' => 'mini',
		'type' => 'text');
	$options[] = array(
		'name' => __('RSS Link', 'options_framework_theme'),
		'id' => 'rss_link',
		'std' => '',
		'class' => 'mini',
		'type' => 'text');
	...
	$options[] = array(
		'name' => __('Sidebar Menu Title', 'options_framework_theme'),
		'desc' => __('Ex: Menu:', 'options_framework_theme'),
		'id' => 'sidebar_menu_title',
		'std' => 'Default Value',
		'type' => 'text');

	$options[] = array(
		'name' => __('Blog / News Title', 'options_framework_theme'),
		'desc' => __('Ex: Blog / News', 'options_framework_theme'),
		'id' => 'blog_news_title',
		'std' => 'Default Text',
		'type' => 'text');
	...
	$options[] = array(
		...
		'desc' => __('Example: Copyright Sideways8 Interactive, LLC', 'options_framework_theme'),
		'id' => 'footer_copyright',
		'std' => '',
		'class' => 'mini',
		'type' => 'text');
	...
	$options[] = array(
		'name' => __('Footer Copyright Year', 'options_framework_theme'),
		'desc' => __('Example: 2011', 'options_framework_theme'),
